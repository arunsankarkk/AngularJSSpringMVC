...
<html>
  <head>  
    <title>English Premier LEague</title>  
     ...
     <link rel="stylesheet" href="static/css/userscreen.css"></link>
   ...
   <p>ENGLISH PREMIER LEAGUE</p>
   	 <div class="generic-container" ng-controller="LoginCtrl as lgctrl" ng-if="!navigateToLogin">
	  ...
	  <script src="static/js/controller/teamList_controller.js"></script>
